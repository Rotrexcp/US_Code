...
class AhorcadoApp:
    def __init__(self, root, palabras, max_intentos=6):
        ...
        root.bind('<Return>', self.comprobar_letra_gui)
        root.bind('<KP_Enter>', self.comprobar_letra_gui)
...
'''
Cuando agreguemos cualquier cambio meter lo siguiente en la terminal:
pyinstaller --onefile --windowed "C:/Users/rodri/OneDrive/Desktop/US_VSCode/VSCode FP/Python/laboratorio/clase2_(3-10)/ahorcado/ahorcadoGUI.py" --add-data "C:/Users/rodri/OneDrive/Desktop/US_VSCode/VSCode FP/Python/laboratorio/clase2_(3-10)/data/palabras_ahorcado.txt;data"
'''