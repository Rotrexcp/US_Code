...
if __name__ == "__main__":
    #test_cargar_palabras("VSCode FP/Python/laboratorio/clase2_(3-10)/data/palabras_ahorcado.txt")
    #PALABRAS = cargar_palabras("VSCode FP/Python/laboratorio/clase2_(3-10)/data/palabras_ahorcado.txt")
