...
public class FactoriaVuelos {
	...
	private static List<String> parseaTripulacion(String cad) {
	    ...
	    Checkers.check("FactoriaVuelos::parseaTripulacion.Formato no valido", trozos.length>2);			//el :: es lo mismo que lambda, reference method
